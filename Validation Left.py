...
# Loading model
model = tf.keras.models.load_model('CNN_1_left')
...
print(pred_test_labels_left[2730:2745])
#
...
#
# report_test = classification_report(Y_test_left, pred_test_labels_left)
# print(report_test)
...
#
#
# print('ROC AUC score:', multiclass_roc_auc_score(Y_test_left, pred_test_labels_left))
#
# c_ax.legend(prop={'size':4})
...
# pred_test_labels_left = to_categorical(pred_test_labels_left, dtype ='float32')
#
...
# roc_auc = dict()
# for i in range(210):
#     fpr[i], tpr[i], _ = roc_curve(Y_test_left[:, i], pred_test_labels_left[:, i])
#     roc_auc[i] = auc(fpr[i], tpr[i])
#
# # Compute micro-average ROC curve and ROC area
# fpr["micro"], tpr["micro"], _ = roc_curve(Y_test_left.ravel(), pred_test_labels_left.ravel())
